...
const createAdminRole = async (userId: string, grantedByUserId: string) => {
  try {
...
const main = async () => {
  try {
    ...
    if (args.length < 2) {
      console.log('Usage: npm run create-admin <userId> <grantedByUserId>');
      console.log('Example: npm run create-admin 507f1f77bcf86cd799439011 507f1f77bcf86cd799439012');
      console.log('');
      console.log('Where:');
...
export { createAdminRole, connectDB };
